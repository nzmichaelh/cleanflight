...
const clivalue_t valueTable[] = {
    ...
    { "rssi_channel",               VAR_INT8   | MASTER_VALUE,  &masterConfig.rxRSSIConfig.channel, 0, MAX_SUPPORTED_RC_CHANNEL_COUNT },
    { "rssi_scale",                 VAR_UINT8  | MASTER_VALUE,  &masterConfig.rxRSSIConfig.scale, RSSI_SCALE_MIN, RSSI_SCALE_MAX },
    { "rssi_ppm_invert",            VAR_INT8   | MASTER_VALUE,  &masterConfig.rxRSSIConfig.ppm_invert, 0, 1 },
